...
class AddDialog(QDialog):
    ...
    def __init__(self, scripts_data: Dict[str, Any], user_permissions: Dict[str, bool] = None, parent=None, edit_mode=False):
        ...
        try:
            if self.edit_type == 'category':
                ...
                if new_value in self.scripts_data[self.primary_type][self.category_name][self.title_name]:
                    ...
                    return
                self.content_edited_signal.emit(self.primary_type, self.category_name, self.title_name ,self.old_value, new_value)
    ...
    def set_add_mode(self, add_type: str, primary_type: str = None, category_name: str = None, title_name: str = None,script_content: str = None):
        """设置新增模式"""
    ...
    def set_edit_mode(self, edit_type: str, old_value: str, primary_type: str = None, category_name: str = None, title_name: str = None):
        """设置编辑模式
    ...
    def set_default_values(self, primary_type: str = None, category_name: str = None, title_name: str = None,script_content: str = None):
        """设置默认值"""
        try:
            # 标记正在设置默认值
